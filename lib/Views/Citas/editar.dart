...
class EditarCitas extends StatefulWidget{
  const EditarCitas({Key? key}) : super(key: key);

  @override
  State<EditarCitas> createState() => _EditarCitas();

}

class _EditarCitas extends State<EditarCitas> {
            ...
            children: [
              ...
              Container(
                ...
                child:ElevatedButton(
                  ...
                  child: const Text("Editar Cita", style: TextStyle(
                      fontSize: 16
                  ),),
