...
class HomeCitas extends StatefulWidget{
  const HomeCitas({Key? key}) : super(key: key);

  @override
  State<HomeCitas> createState() => _HomeCitas();
}

class _HomeCitas extends State<HomeCitas>{
  @override
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.pushReplacementNamed(context, 'citas/registrar');
                              },
