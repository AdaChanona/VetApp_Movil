...
class HomeMascotas extends StatefulWidget{
  const HomeMascotas({Key? key}) : super(key: key);

  @override
  State<HomeMascotas> createState() => _HomeMascotas();
}

class _HomeMascotas extends State<HomeMascotas>{
  @override
