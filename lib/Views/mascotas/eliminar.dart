...
class EliminarMascotas extends StatefulWidget{
  const EliminarMascotas({Key? key}) : super(key: key);

  @override
  State<EliminarMascotas> createState() => _EliminarMascota();

}

class _EliminarMascota extends State<EliminarMascotas>{
            ...
            children: [
              ...
              Container(
                ...
                child:ElevatedButton(
                  ...
                  child: const Text("Eliminar Mascota", style: TextStyle(
                      fontSize: 16
                  ),),
